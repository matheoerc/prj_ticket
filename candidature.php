...
$verification->bindValue(':id', $_SESSION['id'], PDO::PARAM_INT);
...
<head>
    ...
    <title>Candidature Administrateur</title>
...
<nav class="navbar navbar-light bg-light fixed-top">
    <div class="container-fluid">
        ...
        <div class="justify-content-end">
            <a class="btn btn-outline-primary me-2" href="<?php
            ...
            <a href="href=
                    <?php
                        if ($_SESSION['roles'] === 'administrateur') {
                            echo "/projet_ticket/ticket_admin.php";
                        } else {
                            echo "/projet_ticket/ticket_utilisateur.php";
                        }
                    ?>" class="btn btn-outline-primary me-2">Mes Tickets</a>
...
<div class="d-flex align-items-center justify-content-center" style="height: 100vh; padding-top: 70px;">
    <div class="card shadow p-4" style="width: 200%; max-width: 800px; font-size: 30px">
        <div class="card-body">
            <h1 class="text-center mb-4">Candidature Administrateur</h1>
            <form action="candidaturebdd.php" method="post">
                <div class="mb-3">
                    <label for="message" class="form-label">Pourquoi voulez-vous devenir administrateur ?</label>
