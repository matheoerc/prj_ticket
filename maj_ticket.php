...
$requete = "SELECT * FROM ticket WHERE id = :id AND user_id = :user_id";
$enregistrement = $bdd->prepare($requete);
$enregistrement->bindValue(':id', $ticket_id, PDO::PARAM_INT);
    ...
    <div class="d-flex align-items-center justify-content-center" style="height: 100vh; padding-top: 70px;">
        <div class="card shadow p-4" style="width: 200%; max-width: 800px; height:550px; font-size: 30px">
            <div class="card-body">
                ...
                <form action="maj_ticketbdd.php" method="post">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket['id']; ?>">
                    <div class="mb-3">
                        <label for="titre" class="form-label">Titre</label>
                        <input type="text" id="titre" name="titre" class="form-control" value="<?php echo $ticket['titre']; ?>"required>
                    </div>
                    <div class="mb-3">
                        <label for="descri" class="form-label">Description</label>
                        <textarea id="descri" name="descri" class="form-control"  required><?php echo $ticket['description']?></textarea>
                    </div>
                    <div class="mb-3">
