...
$req_sql = "SELECT statut FROM candidature WHERE user_id = :id";
$req = $bdd->prepare($req_sql);
$req->bindValue(':id', $_SESSION['id'], PDO::PARAM_INT);
$req->execute();
$candidature = $req->fetch(PDO::FETCH_ASSOC);
        ...
        <div class="card-body">
            ...
            <?php if ($candidature): ?>
                <div class="alert alert-info text-center">
                    Votre candidature est actuellement :
                    <strong><?php echo $candidature['statut']; ?></strong>
                </div>
            <?php else: ?>
                <form action="candidatureadminbdd.php" method="post">
                    <div class="mb-3">
